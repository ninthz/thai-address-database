...
(function (angular) {
  ...
  var resolveResultAllField = function resolveResultAllField(searchStr, maxResult) {
    searchStr = searchStr.toString().trim();
    if (searchStr === '') {
      return [];
    }
  ...
  var searchAddressWildcard = function searchAddressWildcard(searchStr, maxResult) {
